...
execute_process(
  COMMAND "/usr/bin/git" show-ref "11.0.1"
  WORKING_DIRECTORY "/home/hiari/wd/metal-matmul/multi_core_reuse/.cpmcache/fmt/73b5ec45edbd92babfd91c3777a9e1ab9cac8238"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/hiari/wd/metal-matmul/multi_core_reuse/.cpmcache/fmt/73b5ec45edbd92babfd91c3777a9e1ab9cac8238'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/hiari/wd/metal-matmul/multi_core_reuse/.cpmcache/fmt/73b5ec45edbd92babfd91c3777a9e1ab9cac8238'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
